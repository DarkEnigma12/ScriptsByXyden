...
///@param font_valign
///@param angle
function draw_text_outlined_ext(xx, yy, sep, w, outline_color, string_color, xscale, yscale, alpha, str, fnt=draw_get_font(), fnt_halign=draw_get_halign(), fnt_valign=draw_get_valign(), angle=0) {
...
/// @function string_wordwrap(string,max width)

function string_wordwrap (str,max_width) {
